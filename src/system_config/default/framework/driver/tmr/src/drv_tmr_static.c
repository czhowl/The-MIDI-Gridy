...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_1, 100);
    /* Setup Interrupt */   
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_2, 31250);
    /* Setup Interrupt */   
...
{   
    ...
    /* Setup Interrupt */   
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_T3, INT_PRIORITY_LEVEL3);
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period32BitSet(TMR_ID_4, 1125000000UL);
    /* Setup Interrupt */   
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_T5, INT_DISABLE_INTERRUPT);
